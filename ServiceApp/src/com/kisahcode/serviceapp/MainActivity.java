package com.kisahcode.serviceapp;
...
public class MainActivity extends Activity {
	...
	private static final double DISCOUNT_20_PERCENT = 20.0;
	private static final double DISCOUNT_25_PERCENT = 25.0;
	private static final double THRESHOLD_20_PERCENT = 2000000.0;
	private static final double THRESHOLD_25_PERCENT = 2500000.0;
        ...
        btnHasil.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
	                ...
	                } else if (totalBiaya >= THRESHOLD_20_PERCENT) {
