...
public class UpdateDataActivity extends Activity {
	...
	private EditText id_barangEditText, namaEditText, jenisEditText, stockEditText;
	...
	private void updateData() {
        ...
        new Thread(new Runnable() {
			...
			@Override
			public void run() {
				String urlString = "http://192.168.0.15:8081/gudangkisah/update.php";
                try {
	                ...
	                String postData = "id_barang=" + id_barang +
                            		  "&nama=" + nama +
                            		  "&jenis=" + jenis +
                            		  "&stock=" + stock;
	                ...
	                if (responseCode == HttpURLConnection.HTTP_OK){
	                	runOnUiThread(new Runnable() {
							@Override
							public void run() {
								Toast.makeText(UpdateDataActivity.this, "Data berhasil diupdate", Toast.LENGTH_SHORT).show();
	                	...
	                	runOnUiThread(new Runnable() {
							@Override
							public void run() {
								Toast.makeText(UpdateDataActivity.this, "Gagal mengupdate data", Toast.LENGTH_SHORT).show();
							}
						});
	                }
                } catch (Exception e) {
